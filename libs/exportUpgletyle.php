...
class ExportUpgletyle{
	...
	function UpgletyleExportObject($export_file){
	...
	function getPostList(){
		...
		$output = executeQueryArray('upgletyle.getExportDocumentList',$args);
		if($output->data){
	...
	function getCommentList($document_srl){
		...
		$output = executeQueryArray('upgletyle.getExportCommentList',$args);
		if($output->data){
			foreach($output->data as $attribute){
